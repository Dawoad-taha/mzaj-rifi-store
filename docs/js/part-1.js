/* =========================================================
   MZAJ RIFI - CUSTOM JAVASCRIPT
   CLEAN BASELINE VERSION
   Reviewed: 2026-09-16

   Removed:
   - Legacy global loader (conflicted with homepage-only loader)
   - Legacy cart-total-above-account module (no longer wanted)

   Updated:
   - Product description alignment selector
   - Desktop header comment reflects 5 category links
   ========================================================= */
